...
const Footer = () => {
  return (
    <motion.footer
      className="bg-gradient-to-r from-purple-900 to-purple-700 text-white py-12 px-6"
    ...
    >
      <div className="container mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-center border-b border-purple-600 pb-8">
        ...
        <div className="mt-8 flex flex-col md:flex-row justify-between items-center">
          <div className="flex flex-col md:flex-row items-center gap-4">
            <span className="font-semibold text-lg">Stay updated with new jobs!</span>
            <form className="flex">
              <input
                type="email"
              ...
              <button
                type="submit"
                className="px-4 py-2 bg-purple-600 hover:bg-purple-500 transition rounded-r-full font-semibold"
              >
                Subscribe
              </button>
            </form>
